        ...
        <div className="col-span-1 md:col-span-9 p-8 sm:p-12 flex flex-col items-center justify-center text-center gap-6 bg-white dark:bg-zinc-950">
          ...
          <div className="flex flex-col gap-2 max-w-xl">
            <p className="font-mono text-[11px] sm:text-xs text-zinc-400 dark:text-zinc-500 leading-relaxed tracking-wide select-text">
              Inspired by <a href="https://tailwindcss.com" target="_blank" className="hover:text-zinc-900 dark:hover:text-zinc-50 hover:underline">tailwindcss.com</a> / <a href="https://ui.shadcn.com" target="_blank" className="hover:text-zinc-900 dark:hover:text-zinc-50 hover:underline">ui.shadcn.com</a> / <a href="https://vercel.com" target="_blank" className="hover:text-zinc-900 dark:hover:text-zinc-50 hover:underline">vercel.com</a> / <a href="https://chanhdai.com" target="_blank" className="hover:text-zinc-900 dark:hover:text-zinc-50 hover:underline">chanhdai.com</a>
            </p>
            <p className="font-mono text-[11px] sm:text-xs text-zinc-400 dark:text-zinc-500 leading-relaxed tracking-wide select-text">
